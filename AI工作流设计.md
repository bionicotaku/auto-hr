...
**工作描述与 rubric 生成/编辑 → 最终定稿生成评估规范 → Candidate 原始资料保存 → Candidate 标准化 → 基于 rubric 的多维子分 → 总分 + summary + 证据点**
...
**原始资料保存 → Candidate 标准化 → 按 rubric 逐项分析 → supervisor 汇总**
...
**工作描述与 rubric 生成/编辑 → B 页面点击完成时最终定稿并生成正式评估规范 → Candidate 原始资料保存 → Candidate 轻量标准化 → 基于 rubric 的子 agent 逐项分析 → supervisor 汇总总分、summary 与证据点**
